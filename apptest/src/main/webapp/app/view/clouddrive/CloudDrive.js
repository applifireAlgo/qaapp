Ext.define("Apptest.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Apptest.view.clouddrive.CloudDriveController',
	             'Apptest.view.clouddrive.documentview.DocumentsView',
	             'Apptest.view.clouddrive.drivedetails.DriveDetails',
	             //'Apptest.view.clouddrive.documentview.DocumentListView'
	             ],
