...
Ext
		.define(
				'Apptest.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Apptest.view.logger.tabs.details.DetailsTab',
							'Apptest.view.logger.tabs.fileconnector.FileConnectorTab',
							'Apptest.view.logger.tabs.dbconnector.DBConnectorTab',
							'Apptest.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Apptest.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Apptest.view.logger.LogConfigurationTabPanelController',
