 ...
 * 
 */
Ext.define('Apptest.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Apptest.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
