 ...
 * 
 */
Ext.define('Apptest.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Apptest.view.securityconfig.SecurityConfigController',
			'Apptest.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
