Ext
		.define(
				'Apptest.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Apptest.view.searchengine.search.SearchEngineMainPanelController','Apptest.view.searchengine.search.PanelHeaderField' ,'Apptest.view.searchengine.search.ReportGridView','Apptest.view.searchengine.search.ReportChartView','Apptest.view.searchengine.search.documentView','Apptest.view.searchengine.search.DouMeanView','Apptest.view.googlemaps.map.MapPanel'],
