Ext.define('Apptest.view.searchengine.search.SearchEngineMainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'solrsearchmainpanel',
	

	requires : ['Apptest.view.searchengine.search.NorthPanel', 'Apptest.view.searchengine.search.SearchResult','Apptest.view.searchengine.search.SearchEngineMainPanelController'],
