Ext.define('Apptest.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Apptest.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Apptest.view.console.ConsoleWindow');
