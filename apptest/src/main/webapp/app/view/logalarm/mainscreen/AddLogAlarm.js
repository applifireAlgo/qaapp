 ...
 * 
 */
Ext.define('Apptest.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Apptest.view.logalarm.mainscreen.AddLogAlarmController',
			'Apptest.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Apptest.view.logalarm.mainscreen.AppAlarmPanel',
