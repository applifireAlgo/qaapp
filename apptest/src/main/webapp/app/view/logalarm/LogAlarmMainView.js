 ...
 * 
 */
Ext.define('Apptest.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Apptest.view.logalarm.LogAlarmMainViewController',
			'Apptest.view.logalarm.tree.LogAlarmTreePanel',
			'Apptest.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
