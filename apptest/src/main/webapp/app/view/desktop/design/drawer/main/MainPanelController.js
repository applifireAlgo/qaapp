Ext.define('Apptest.view.desktop.design.drawer.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Apptest.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Apptest.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Apptest.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Apptest.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Apptest.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Apptest.view.clouddrive.CloudDrive");
    },
