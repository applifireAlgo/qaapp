Ext.define('Apptest.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Apptest.view.usermanagement.enduser.UserProfileController', 'Apptest.view.usermanagement.admin.AddUserDetailsViewModel', 'Apptest.model.AddUserDataModel' ],
