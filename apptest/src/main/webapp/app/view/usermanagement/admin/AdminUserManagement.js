Ext.define('Apptest.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Apptest.view.usermanagement.admin.UserPasswordReset',
	            'Apptest.view.usermanagement.admin.AddUserDetails',
	            'Apptest.view.usermanagement.admin.ViewUser'],
