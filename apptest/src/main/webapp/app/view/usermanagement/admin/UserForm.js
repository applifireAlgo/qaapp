Ext.define('Apptest.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Apptest.view.usermanagement.admin.AddUserDetailsViewModel', 'Apptest.model.AddUserDataModel' ],
