...
public class ContactTypeTestCase extends EntityTestCriteria {
    ...
    private ContactType createContactType(Boolean isSave) throws Exception {
        ...
        contacttype.setContactTypeDesc("XE6iUOQV7PNuN5sdnyG4NWSTSV7ugKHY9mejysRjF4TvWhLV0C");
        contacttype.setContactType("0ij2AYskvKOTpvo7gka95TQrRsF0SYw5knGBOtbCbkUlhwpzz5");
        contacttype.setContactTypeIcon("bgcQ5UoehYFst3TuG0UOWnBgy8pwHm2SqORroTNjOqrkYly725");
    ...
    public void test2Update() {
        try {
            ...
            contacttype.setContactTypeDesc("b7N870ozvlmKuWEywRREZHqLwAfbJQzxb3ckX8biB5e0aIN93P");
            contacttype.setContactType("kXQXLgS38oR9k6T7vz9Wws9hV2rsaQ0xt6ZEO85d3WD5VuRToJ");
            contacttype.setContactTypeIcon("0Ret1jVlumScbPRVN2PQ3kRtsRIaVHz9WBVWvm5B9vF8em1GKh");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "contactType", "u1VjspNSTCskcACvoVg97YvyCrzIZTfgIVLRclW5LCsciOFYgEW1o3dFqgd3S8qM6HTGyJ40STNiy3GQtaPJkmLFZxamzOkHNtdcogGxksrK13gzcfG83a2jqBabfPPgw"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 3, "contactTypeDesc", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "contactTypeIcon", "NuWAdXF9GN3gf8Lusaok5ZSuKW5fZhnZwVXiRVPXnMkQ1SfTqcSoY3yRhaPBYy2zrAJ3OtXhLul8qqCeX7VQA8yURElET5mUegjalazyLsYwNN3OlZtBkQUCv2TYDTNfQ"));
