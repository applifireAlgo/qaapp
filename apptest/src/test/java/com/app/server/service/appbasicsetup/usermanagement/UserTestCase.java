...
public class UserTestCase extends EntityTestCriteria {
    ...
    private User createUser(Boolean isSave) throws Exception {
        ...
        useraccesslevel.setLevelIcon("4J2sH1L4v094ulkJWWnQgpFD2320zg2WWfQHFNqFHZ08YSlsxx");
        useraccesslevel.setLevelHelp("xMZCh45ZSY9T22i4tl0Dcv2PpTeOHrWv58OecUY1hLpOIhs8xO");
        useraccesslevel.setLevelName("txoAxKiIFk9yWYAUmmzJBlG1JCYKXZVU5jXJbeRj01ouhud7hN");
        useraccesslevel.setUserAccessLevel(valueGenerator.getRandomInteger(99999, 0));
        useraccesslevel.setLevelDescription("WeIwlNUGpCZrylJexl6SxhFHcrnUUV2ZgF3yiZ10yOQ9160pVP");
        ...
        useraccessdomain.setDomainName("UJifTCq6KCx5kBHb2rzYBFLXacWbsGUk6RCjUPtjwsfTk22YQ8");
        useraccessdomain.setDomainIcon("GzX0X6t80d2dZHOMMYCLvl1SWtNoQDdegQmX3uMHNqJO2viz2z");
        useraccessdomain.setDomainHelp("o5fEOoSGpXvQVn69dgOQjoGxCnRXmKV4fxob9sSujmoyqvGoOQ");
        useraccessdomain.setDomainDescription("q1ECN22GJCiQxnTTMKkzYC2SalavQJesfEltkFr4QCA3CcODma");
        ...
        User user = new User();
        user.setUserAccessCode(27042);
        user.setPasswordAlgo("6piSFo8E8GZC6DVaUKA7pqIU1zmhcPYaMLFvyEn7Z6Y7MbEFLy");
        user.setUserAccessLevelId((java.lang.String) UserAccessLevelTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setUserAccessDomainId((java.lang.String) UserAccessDomainTest._getPrimarykey()); /* ******Adding refrenced table data */
        user.setPasswordExpiryDate(new java.sql.Timestamp(1464944132307l));
        user.setLastPasswordChangeDate(new java.sql.Timestamp(1464944132307l));
        user.setIsLocked(1);
        user.setGenTempOneTimePassword(1);
        user.setIsDeleted(1);
        user.setSessionTimeout(2289);
        ...
        question.setQuestionDetails("Zz6txTGuM6");
        question.setLevelid(6);
        question.setQuestion("E40O6xeXu6WYmKiXsLKcxI2qF39kwAeGsfm7eQ4upBAa9yVRPu");
        question.setQuestionIcon("6z8BUtP8465uCvPqBbOW3ttTMYkVFMMXlRPCJgoEZhoDKwVxa4");
        ...
        passrecovery.setAnswer("LPB3e8Jy0Z4W8lxpEqXRfnPFBCA1KpOWtomKjgzoedDVbpQtnE");
        listOfPassRecovery.add(passrecovery);
        user.addAllPassRecovery(listOfPassRecovery);
        UserData userdata = new UserData();
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1464944132731l));
        userdata.setPassword("S4iHHpV420ndiTHYmG2r9A6NIoi5EDFdCxhOqIJyfiytBpQlFQ");
        userdata.setOneTimePasswordGenDate(new java.sql.Timestamp(1464944132759l));
        userdata.setPassword("lmEVfKTXGWaROo2qLTrOjVTevww0QGPSHxJ0WQCrSL1MmDW70p");
        userdata.setUser(user);
        userdata.setOneTimePassword("iaSRmMbZ3WQTRuoMjdMqlkm2PvETinyu");
        userdata.setLast5Passwords("qZllASIULfVzd8OH5OhXeAYyIpJ0w1LDeBe3Za2Y9UbDZ22ee6");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 1, "userAccessCode", 86955));
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 8, "passwordAlgo", "vMb0slrIa7kAmjHQe6YnU1tDXiOEcs6a2gI7BDOowkRXUSsds0Zy0ZQvAx8kwzsDG"));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 9, "sessionTimeout", 5541));
