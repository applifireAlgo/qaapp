...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionDetails("JeOsv5OqEh");
        question.setLevelid(2);
        question.setQuestion("v9wduv6fDfdF2sUgMqXoGVGsZdKYiPkKcTTQtoc9C6uqrF5OU7");
        question.setQuestionIcon("YOolsbhkjEFIeaE94gougF2byvKWFy9Zyu8TB9vETeMBny5dd8");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionDetails("Qn5jmqLDd8");
            question.setLevelid(10);
            question.setQuestion("YGYWWnuy8rWfZCxUHlCnFEdODgoauDxXKN3TOIa49BDbulBAYR");
            question.setQuestionIcon("Gj1b55Q0JTKwF7PtgJ9WMhGYEiQVtkrREWRMLlm0eFnlw2rzAM");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "PMpNwsiWQBsjTvAwKXI64baqOWMz0UHRqTaAJTv3OHb7NkNgFb4CIwdKIADd5kT1y"));
